...
Frequently Asked Questions about the I<nms> CGI programs ( $Date: 2002-05-22 09:53:00 $ )
...
You should ask your System Administrator or web hosting provider if the
program C<blat> is available, C<blat> is a command line program for Windows
