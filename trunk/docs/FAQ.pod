...
Frequently Asked Questions about the I<nms> CGI programs ( $Date: 2002-02-27 09:04:28 $ )
...
the I<nms> script will work exactly the the same way. If you set it to
...
Blat is available from  http://gepasi.dbs.aber.ac.uk/softw/Blat.html
